...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
//	ConfigFolderLocator — finds the project root and makes the .code-agent folder
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////

/**
 * The name of the folder code-agent reads everything out of.
 */
export const CONFIG_FOLDER_NAME = '.code-agent';

/**
 * The subfolders that always exist inside the `.code-agent` folder.
 */
export const CONFIG_SUBFOLDER_NAMES = ['agents', 'commands', 'skills', 'memory', 'sessions'];

/**
 * Finds the project root and makes the `.code-agent` folder.
 */
export class ConfigFolderLocator {
	/**
	 * Works out where the `.code-agent` folder belongs.
	 *
	 * The project root is the nearest folder at or above the working folder that holds a `.git`, and the working
	 * folder itself when there is no `.git` anywhere above it. That makes code-agent behave the same from any
	 ...
	 * @returns The project root and the path of the `.code-agent` folder.
	 */
	...
	/**
	 * Makes the `.code-agent` folder and its subfolders when they are absent.
	 *
	 * A fresh project works with no setup because of this. Nothing is overwritten: a folder that already exists
	 * is left exactly as it is.
	 *
	 * @param paths The project root and the path of the `.code-agent` folder.
	 * @returns Nothing.
	 */
