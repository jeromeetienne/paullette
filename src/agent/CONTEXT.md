...
## Purpose
Turns the configuration and whatever was read out of the `.code-agent` folder into an agent the OpenAI Agents SDK can run.
...
## Background
- The three calls in `model_provider.ts` were proven live against LM Studio before any of this was written; see the "What is already proven" section of [issue #1](https://github.com/jeromeetienne/code-agent/issues/1).
