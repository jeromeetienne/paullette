 ...
 *
 * This is the single command that answers "is paullette done". A step that passes proves something was really
 * seen; a step that is pending says which part of paullette has still to be written; a step that fails is a fault
...
export class RunVerification {
	...
	static async main(commandLineArguments: string[]): Promise<void> {
		...
		process.stdout.write(`\n${Chalk.bold('paullette verification')}  —  ${chosenSteps.length} steps\n\n`);
