# Directory Context: `/test/unit/libs`

## Purpose
Holds what the unit test files share: the temporary folders they write into, the permission asker they answer with, the way they call a tool, and the capture that keeps their printing out of the test output.
